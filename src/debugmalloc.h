...
//
// WARNING! THIS IS NOT THE ORIGINAL 'debugmalloc.h'
// I modified it to suppress a warning
// ('strncpy' output truncated copying 64 bytes from a string of length 73 [-Werror=stringop-truncation])
// in line 116
// / Sasszem /
